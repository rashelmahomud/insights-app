...
export default function section1() {
    return (
        <div className="lg:mx-36 p-10 mb-20 z-20 mt-[-150px]">

            <h1 className="text-center mb-20">Latest Insights</h1>
            <div className="text-5xl font-bold text-gray-800">
                <h1 className="text-3xl">Life Insurance: Securing Your <br />
                    Future</h1><br/>
                    <span className="text-sm">investing | 5 minute read</span>
